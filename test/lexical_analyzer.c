        ...
        switch(state) {
            ...
            case 1:
                if (isalnum(c) || c == '_') {
                    ...
                    buffer[idx] = '\0';
                    if (strcmp(buffer, "main") == 0|| strcmp(buffer, "output") == 0 || strcmp(buffer, "input") == 0 || strcmp(buffer, "if") == 0 || strcmp(buffer, "else") == 0 || strcmp(buffer, "while") == 0 || strcmp(buffer, "for") == 0 || strcmp(buffer, "break") == 0 || strcmp(buffer, "continue") == 0 || strcmp(buffer, "return") == 0) {
                        printf("KEYWORD(%s)\n", buffer);
